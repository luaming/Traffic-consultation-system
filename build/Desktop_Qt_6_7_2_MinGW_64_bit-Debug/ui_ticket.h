...
public:
    ...
    void setupUi(QWidget *Ticket)
    {
        ...
        stime->setGeometry(QRect(10, 10, 81, 31));
        ...
        line->setGeometry(QRect(87, 25, 74, 3));
        line->setFrameShape(QFrame::Shape::HLine);
        line->setFrameShadow(QFrame::Shadow::Sunken);
        tool = new QLabel(Ticket);
        tool->setObjectName("tool");
        tool->setGeometry(QRect(102, 10, 41, 16));
        QFont font1;
        ...
        etime->setGeometry(QRect(160, 10, 72, 31));
        ...
        label_6->setGeometry(QRect(15, 60, 15, 15));
...
"}"));
        ...
        label_7->setGeometry(QRect(160, 60, 15, 15));
...
"}"));
        ...
        splace->setGeometry(QRect(50, 60, 58, 12));
        ...
        eplace->setGeometry(QRect(190, 60, 58, 12));
        ...
        arrive->setGeometry(QRect(20, 70, 181, 20));
        ...
        time->setGeometry(QRect(85, 30, 71, 16));
        time->setFont(font1);
