...
"}"));
        ...
        frame_6->setGeometry(QRect(0, 200, 800, 50));
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 759, 119));
        scrollArea->setWidget(scrollAreaWidgetContents);
        summary = new QLabel(mainbody);
        summary->setObjectName("summary");
        summary->setGeometry(QRect(20, 270, 481, 16));
